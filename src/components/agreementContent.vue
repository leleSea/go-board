                       ...
                       <div class="step-content" v-for="(n, j) in v.content" :key="j">
                           ...
                           <div class="step-content-table" v-if="isTable(n)">
                            ...
                            <ul class="step-content-table" v-if="isSubContent(n)">
                                <li class="step-content-txt" v-for="(ic, ii) in n.subContent" :key="ii">{{$t(ic)}}</li>
                            </ul>
    ...
    export default {
        ...
        methods: {
            ...
            pageInit(){
                ...
                this.LOADING.open()
                // this.GLOBAL.getStaticData(`${process.env.BASE_URL}txt/productIntro.json`)
                let path = `${this.GLOBAL.assetsUrl}/txt/agreement.json`
                // let path = `${process.env.BASE_URL}txt/agreement.json`
